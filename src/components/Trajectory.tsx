...
const EARTH_VISUAL_RADIUS = 0; // Disabled — Earth at true scale (0.637 su), trajectory clears it naturally
const MOON_VISUAL_RADIUS = 0.40; // Moon sphere radius 0.347 + buffer (JPL position gives 0.84 su clearance)
