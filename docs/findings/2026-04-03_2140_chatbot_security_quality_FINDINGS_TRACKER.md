...
**Last Updated**: 2026-04-04 00:04 UTC
...
|---|---------|------|----------|--------|-------|--------|
| F1 | XSS via dangerouslySetInnerHTML on AI responses | Vulnerability | **Critical** | Resolved | Resolved | [Report](2026-04-03_2140_chatbot_security_quality.md) |
| F2 | API key in URL query parameter | Defect | **Medium** | Resolved | Resolved | [Report](2026-04-03_2140_chatbot_security_quality.md) |
| F3 | No input validation on messages array | Defect | **Medium** | Resolved | Resolved | [Report](2026-04-03_2140_chatbot_security_quality.md) |
| F4 | Duplicated and drifting video data | Defect | **Medium** | Resolved | Resolved | [Report](2026-04-03_2140_chatbot_security_quality.md) |
| F5 | ChatPart type divergence server/client | Defect | **Medium** | Resolved | Resolved | [Report](2026-04-03_2140_chatbot_security_quality.md) |
| F6 | Unsanitized videoId in iframe src | Defect | **Medium** | Resolved | Resolved | [Report](2026-04-03_2140_chatbot_security_quality.md) |
| F7 | Message sanitization filter runs over unbounded input before slice | Defect | **Medium** | Resolved | Resolved | [Report](../reviews/2026-04-04_0004_diff.md) |
...
- [ ] **F7.3**: Verify fix (Stage: Verified)
